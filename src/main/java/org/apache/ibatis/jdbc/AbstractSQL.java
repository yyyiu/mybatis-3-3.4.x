...
public abstract class AbstractSQL<T> {
    ...
    private static class SQLStatement {
        ...
        public enum StatementType { // 用来确定sql语句的类型
         ...
         * @param open 关键字开始的字符
         * @param close 关键字结束的字符
         * @param conjunction 连接关键字，一般为 and和or
         */
        ...
        public String sql(Appendable a) { // StringBuilder 实现了 Appendable
            ...
            switch (statementType) { // 枚举，不同类型走不同case
                case DELETE:
