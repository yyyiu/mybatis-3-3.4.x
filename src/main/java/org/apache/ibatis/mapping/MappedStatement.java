...
public final class MappedStatement {
  ...
  /*
  <select id="xx" parameterType="xx" parameterMap="xx"
                  resultType="xx" resultMap="xx"
                  flushCache="false" useCache="true" timeout="1000" fetchSize="256"
                  statementType="xx" resultSetType="xx">
      select * from xx
   </select>
   */
    /**
    ...
    /**
     * 参数可选值为STATEMENT、PREPARED或CALLABLE，这会让MyBatis分别使用
     * Statement、PreparedStatement或CallableStatement与数据库交互，默认值为PREPARED。
     */
