package top.yyiu.mybatis.plugin;
...
/**
 * 作用于：分页插件
 *  通过 RowBounds 参数获取分页信息，并生成相应的 limit 语句。之后拼接 sql，并使用该 sql 作为参数创建 StaticSqlSource。
 *  最后通过反射替换 MappedStatement 对象中的 sqlSource 字段
 * @author pc
 * @date 2020/5/4
 */
@Intercepts({
...
public class InterceptionPlug implements Interceptor {
